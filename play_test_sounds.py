...
stims = OrderedDict([('pip', (pipwin, sound.TonePip)), ('pipmod', (pipmodwin, sound.SAMTone)),
    ...
    ('clicks', (clickwin, sound.ClickTrain)), ('fmsweep', (sound.FMSweep))])
specs = OrderedDict([('pip', (pipwins, sound.TonePip)), ('pipmod', (pipmodwins, sound.SAMTone)),
    ...
    ('clicks', (clickwins, sound.ClickTrain)), ('fmsweep', (fmwins, sound.FMSweep))])
...
if stim in stims:
    ...
    if stim in ['clicks']:
        ...
        save = stims[stim][1](rate-Fs, duration=1.0, dbspl=level,
                            start=0., ramp='linear', freqs=[0.5, 2.5])
    else:
