	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 Gly6S /Users/pbmanis/Desktop/Python/nrnlibrary/nrnlibrary/i386/Gly6S.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Model of glycine receptors";
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 114 in file Gly6S.mod:\n:   ENDVERBATIM\n"); nrn_complain(_p); abort_run(error);}
...
static _initlists() {
 ...
 _slist1[4] = &(D1) - _p;  _dlist1[4] = &(DD1) - _p;
