...
extern int nrn_get_mechtype();
 ...
 "setdata_klt2", _hoc_setdata,
 "rates_klt2", _hoc_rates,
 "trates_klt2", _hoc_trates,
 0, 0
};
...
#define KineticMeasureTemp KineticMeasureTemp_klt2
 double KineticMeasureTemp = 22;
#define Q10 Q10_klt2
 double Q10 = 3;
#define usetable usetable_klt2
 double usetable = 1;
#define zss zss_klt2
 double zss = 0.5;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gkltbar_klt2", 0, 1e+09,
 "usetable_klt2", 0, 1,
 "zss_klt2", 0, 1,
 0,0,0
};
 ...
 "Q10_klt2", "1",
 "KineticMeasureTemp_klt2", "degC",
 "gkltbar_klt2", "mho/cm2",
 "i_klt2", "mA/cm2",
 "gklt_klt2", "mho/cm2",
 "iklt_klt2", "mA/cm2",
 "winf_klt2", "1",
 ...
 "zss_klt2", &zss_klt2,
 "Q10_klt2", &Q10_klt2,
 "KineticMeasureTemp_klt2", &KineticMeasureTemp_klt2,
 "usetable_klt2", &usetable_klt2,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 klt2 /Users/pbmanis/Desktop/Python/nrnlibrary/nrnlibrary/i386/klt2.mod\n");
...
static _initlists(){
 ...
 _slist1[1] = &(z) - _p;  _dlist1[1] = &(Dz) - _p;
   _t_winf = makevector(902*sizeof(double));
   _t_zinf = makevector(902*sizeof(double));
_first = 0;
}
