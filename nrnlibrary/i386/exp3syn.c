	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Exp3Syn /Users/pbmanis/Desktop/Python/nrnlibrary/nrnlibrary/i386/exp3syn.mod\n");
...
/*CVODE*/
 ...
 static int state (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) { {
    g = g + (1. - exp(dt*(( - 1.0 ) / tau1)))*(- ( 0.0 ) / ( ( - 1.0 ) / tau1 ) - g) ;
   }
  return 0;
}
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   g = A * pow ( ( 1.0 - exp ( - t / taur ) ) , N ) * ( ( 1.0 - F ) * exp ( - t / tau1 ) + F * exp ( - t / tau2 ) ) ;
   i = g * ( v - Erev ) ;
   }
 _current += i;
