	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 iCAN /Users/pbmanis/Desktop/Python/nrnlibrary/nrnlibrary/i386/ican.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("iCAN", "cannot be used with CVODE");}
