...
extern int nrn_get_mechtype();
 ...
 "setdata_kpksk", _hoc_setdata,
 "evaluate_fct_kpksk", _hoc_evaluate_fct,
 "states_kpksk", _hoc_states,
 0, 0
};
 /* declare global and static user variables */
#define beta beta_kpksk
 double beta = 0.002;
#define cac cac_kpksk
 double cac = 0.01;
#define taumin taumin_kpksk
 double taumin = 0.1;
 ...
 "beta_kpksk", &beta_kpksk,
 "cac_kpksk", &cac_kpksk,
 "taumin_kpksk", &taumin_kpksk,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 kpksk /Users/pbmanis/Desktop/Python/nrnlibrary/nrnlibrary/i386/kpksk.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("kpksk", "cannot be used with CVODE");}
