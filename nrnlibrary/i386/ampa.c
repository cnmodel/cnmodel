...
#define Alpha Alpha_AMPA_Standard
 double Alpha = 0.94;
#define Beta Beta_AMPA_Standard
 double Beta = 0.18;
#define Cdur Cdur_AMPA_Standard
 double Cdur = 0.3;
#define Erev Erev_AMPA_Standard
 double Erev = 0;
#define Rtau Rtau_AMPA_Standard
 double Rtau = 0;
#define Rinf Rinf_AMPA_Standard
 double Rinf = 0;
 ...
 "Cdur_AMPA_Standard", "ms",
 "Alpha_AMPA_Standard", "/ms",
 "Beta_AMPA_Standard", "/ms",
 "Erev_AMPA_Standard", "mV",
 "Rtau_AMPA_Standard", "ms",
 "i", "nA",
 "g", "umho",
 0,0
};
 ...
 "Cdur_AMPA_Standard", &Cdur_AMPA_Standard,
 "Alpha_AMPA_Standard", &Alpha_AMPA_Standard,
 "Beta_AMPA_Standard", &Beta_AMPA_Standard,
 "Erev_AMPA_Standard", &Erev_AMPA_Standard,
 "Rinf_AMPA_Standard", &Rinf_AMPA_Standard,
 "Rtau_AMPA_Standard", &Rtau_AMPA_Standard,
 0,0
};
...
#define _tqitem &(_ppvar[2]._pvoid)
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 AMPA_Standard /Users/pbmanis/Desktop/Python/nrnlibrary/nrnlibrary/i386/ampa.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 90 in file ampa.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
