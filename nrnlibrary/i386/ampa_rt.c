...
#define Rc2 Rc2_AMPA_RT
 double Rc2 = 0.25;
#define Ro2 Ro2_AMPA_RT
 double Ro2 = 2;
#define Rc1 Rc1_AMPA_RT
 double Rc1 = 2;
#define Ro1 Ro1_AMPA_RT
 double Ro1 = 100;
#define Rr Rr_AMPA_RT
 double Rr = 0.02;
#define Rd Rd_AMPA_RT
 double Rd = 30;
#define Ru2 Ru2_AMPA_RT
 double Ru2 = 200;
#define Ru1 Ru1_AMPA_RT
 double Ru1 = 0.3;
#define Rb Rb_AMPA_RT
 double Rb = 13;
#define aflag aflag_AMPA_RT
 double aflag = 1;
#define usetable usetable_AMPA_RT
 double usetable = 1;
#define vmax vmax_AMPA_RT
 double vmax = 100;
#define vmin vmin_AMPA_RT
 double vmin = -120;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_AMPA_RT", 0, 1,
 0,0,0
};
 ...
 "vmin_AMPA_RT", &vmin_AMPA_RT,
 "vmax_AMPA_RT", &vmax_AMPA_RT,
 "Rb_AMPA_RT", &Rb_AMPA_RT,
 "Ru1_AMPA_RT", &Ru1_AMPA_RT,
 "Ru2_AMPA_RT", &Ru2_AMPA_RT,
 "Rd_AMPA_RT", &Rd_AMPA_RT,
 "Rr_AMPA_RT", &Rr_AMPA_RT,
 "Ro1_AMPA_RT", &Ro1_AMPA_RT,
 "Rc1_AMPA_RT", &Rc1_AMPA_RT,
 "Ro2_AMPA_RT", &Ro2_AMPA_RT,
 "Rc2_AMPA_RT", &Rc2_AMPA_RT,
 "aflag_AMPA_RT", &aflag_AMPA_RT,
 "usetable_AMPA_RT", &usetable_AMPA_RT,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 AMPA_RT /Users/pbmanis/Desktop/Python/nrnlibrary/nrnlibrary/i386/ampa_rt.mod\n");
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 163 in file ampa_rt.mod:\n    SOLVE kstates METHOD sparse\n"); nrn_complain(_p); abort_run(error);}
