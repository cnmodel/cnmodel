	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 it /Users/pbmanis/Desktop/Python/nrnlibrary/nrnlibrary/i386/it.mod\n");
 ...
 v=_v;
{
 ...
 { {
 for (; t < _break; t += dt) {
 error =  euler(_ninits, 1, _slist1, _dlist1, _p, &t, dt, castate, &_temp1);
 if(error){fprintf(stderr,"at line 72 in file it.mod:\n	SOLVE castate METHOD euler\n"); nrn_complain(_p); abort_run(error);}
