...
#define _f_exptable _f_exptable_GLY2
#define exptable exptable_GLY2
 extern double _f_exptable();
 extern double exptable();
 /* declare global and static user variables */
#define Alpha Alpha_GLY2
 double Alpha = 0.53;
#define Beta Beta_GLY2
 double Beta = 0.18;
#define Cdur Cdur_GLY2
 double Cdur = 1;
#define Cmax Cmax_GLY2
 double Cmax = 1;
#define Deadtime Deadtime_GLY2
 double Deadtime = 1;
#define Rtau Rtau_GLY2
 double Rtau = 0;
#define Rinf Rinf_GLY2
 double Rinf = 0;
#define usetable usetable_GLY2
 double usetable = 1;
 ...
 "Cmax_GLY2", &Cmax_GLY2,
 "Cdur_GLY2", &Cdur_GLY2,
 "Alpha_GLY2", &Alpha_GLY2,
 "Beta_GLY2", &Beta_GLY2,
 "Deadtime_GLY2", &Deadtime_GLY2,
 "Rinf_GLY2", &Rinf_GLY2,
 "Rtau_GLY2", &Rtau_GLY2,
 "usetable_GLY2", &usetable_GLY2,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 GLY2 /Users/pbmanis/Desktop/Python/nrnlibrary/nrnlibrary/i386/gly2.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("GLY2", "cannot be used with CVODE");}
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 147 in file gly2.mod:\n	SOLVE release\n"); nrn_complain(_p); abort_run(error);}
