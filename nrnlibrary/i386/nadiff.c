...
extern int nrn_get_mechtype();
 ...
 "setdata_nadiff", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define beta beta_nadiff
 double beta = 1;
#define depth depth_nadiff
 double depth = 0.1;
 ...
 "depth_nadiff", &depth_nadiff,
 "beta_nadiff", &beta_nadiff,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 nadiff /Users/pbmanis/Desktop/Python/nrnlibrary/nrnlibrary/i386/nadiff.mod\n");
 ...
 v=_v;
{
  ...
  nai = _ion_nai;
 {
   na = na + ( 10000.0 ) * dt * ( ( - 1.0 / ( 2.0 * F ) * ina / ( depth ) ) - ( 0.0001 ) * beta * na ) ;
   if ( na < 1e-5 ) {
     na = 1e-4 ;
     }
   nai = na ;
