...
project = u'CNModel'
copyright = u'2017-2020, Paul B. Manis and Luke Campagnola'
...
# built documents.
#
# This data should be obtained from the top path
...
print('cnmodel version: ', version)

# The short X.Y version.
version = version # u'0'
# The full version, including alpha/beta/rc tags.
release = version # u'0.2'
