...
project = u'cnmodel'
copyright = u'2014, Paul B. Manis and Luke Campagnola'
...
latex_documents = [
  ('index', 'cnmodel.tex', u'cnmodel Documentation',
...
man_pages = [
    ('index', 'cnmodel', u'cnmodel Documentation',
     [u'Paul B. Manis and Luke Campagnola'], 1)
]
...
texinfo_documents = [
  ('index', 'cnmodel', u'cnmodel Documentation',
   u'Paul B. Manis and Luke Campagnola', 'cnmodel', 'One line description of project.',
   'Miscellaneous'),
]
